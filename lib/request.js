...
module.exports = {
    ...
    get: function (url, callback) {
        ...
        request(options, function (error, response, body) {
            ...
            //Old style response
            if(body !== undefined && ajv.validate(schema, body)){
                callback(body.code, body.msg);
            }
            //New Style response start here
            else if(response.statusCode === statusCodes.OK || response.statusCode === statusCodes.CREATED || response.statusCode === statusCodes.NO_CONTENT){
                callback(null, body);
            }
